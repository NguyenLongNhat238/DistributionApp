...
def validate_password(password, user=None, password_validators=None):
    ...
    for validator in password_validators:
        try:
            ...
            errors.append(error.__str__()[2:-2])
    if errors:
        return errors
...
class MinimumLengthValidator:
    ...
    def get_help_text(self):
        return ngettext(
            "Mật khẩu quá ngắn. Nó phải chứa ít nhất %(min_length)d ký tự.",
            "Mật khẩu quá ngắn. Nó phải chứa ít nhất %(min_length)d ký tự.",
            self.min_length,
...
class CommonPasswordValidator:
    ...
    def validate(self, password, user=None):
        if password.lower().strip() in self.passwords:
            raise ValidationError(
                _("Mật khẩu quá phổ biến."),
                code="password_too_common",
            )

    def get_help_text(self):
        return _("Mật khẩu của bạn không được là mật khẩu thường được sử dụng.")
...
class NumericPasswordValidator:
    ...
    def get_help_text(self):
        return _("Mật khẩu này hoàn toàn là số.")
