...
class Product(CompanyModelBase):
    ...
    picture = models.ImageField(
        null=True, upload_to='products/%Y/%m', blank=True)
    brand = models.CharField(max_length=50, null=True, blank=True)
    specification = models.TextField(null=True, blank=True, help_text=_(
    ...
    purchase_price = MoneyField(
        max_digits=14, decimal_places=3, default=0, default_currency='VND',
    ...
    supplier = models.ForeignKey(
        Supplier, on_delete=models.SET_NULL, null=True, blank=True, related_name='products_supplier_related')

    category = models.ForeignKey(
        Category, on_delete=models.SET_NULL, null=True, blank=True, related_name="product_category_related"
    )
...
class Inventory(CompanyModelBase):
    ...
    product = models.OneToOneField(
        Product, on_delete=models.CASCADE, null=True, related_name="inventory_product_related")
...
class Warehouse(CompanyModelBase):
    purchase = models.ForeignKey(
        "transaction.Purchase", on_delete=models.CASCADE, null=True, related_name='warehouse_purchase_related')
    date = models.DateTimeField(null=True, blank=True)
