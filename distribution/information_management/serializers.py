...
from .models import Channel, Company, Customer, Employee, Supplier
...
class CompanySerializer(ModelBaseSerializer, BaseModelUserCreatedSerializer):
    class Meta:
        model = Company
        fields = (
            ModelBaseSerializer.Meta.fields
        ...
        extra_kwargs = {
            **ModelBaseSerializer.Meta.extra_kwargs,
...
class CustomerDetailSerializer(CustomerSerializer):
    class Meta:
        ...
        read_only_fields = CustomerSerializer.Meta.read_only_fields + ["full_name"]
...
class EmployeeDetailSerializer(EmployeeSerializer):
    class Meta:
        ...
        read_only_fields = EmployeeSerializer.Meta.read_only_fields + ["full_name"]
...
class ChannelSerializer(BaseCompanyUserCreatedSerializer):
    class Meta:
        model = Channel
        fields = BaseCompanyUserCreatedSerializer.Meta.fields + ["name", "description"]
